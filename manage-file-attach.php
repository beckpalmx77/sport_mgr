                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="add-files.php?stid=<?php echo htmlentities($result->StudentId); ?>"><i
                                                                        class="fa fa-file-image-o" title="เพิ่ม (เอกสาร/ภาพถ่าย)"></i> </a>
                                                                &nbsp;
                                                                <a href="manage-edit-files.php?rollid=<?php echo htmlentities($result->RollId); ?>"><i
                                                                        class="fa fa-edit" title="ดู/แก้ไข (เอกสาร/ภาพถ่าย)"></i></a>
                                                            </td>
                                                        </tr>
                                                        <?php $cnt = $cnt + 1;
                                                    }
