...
<div class="container">
    ...
    <div class="card">
        <div class="card-header card bg-success text-white"><h3><i class="fa fa-newspaper-o"></i>&nbsp;&nbsp;ประมวลภาพกิจกรรมต่างๆ
            </h3>
        </div>
        <div class="card-body">
            ...
            <div class="card-columns">
                ...
                $sql_count = "SELECT id FROM tblslide where type_image = 'I'";
                ...
                $sql = "SELECT * from tblslide where type_image = 'I' order by id desc LIMIT " . $offset . "," . $total_records_per_page;
