                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">ทะเบียนประเภทกีฬา</h2>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                <a href="create-sporttype.php"
                                                   class="btn btn-primary btn-labeled">เพิ่มประเภทกีฬา<span
                                        ...
                                        <div class="panel-body p-20">
                                            <table id="example" class="display table table-striped table-bordered"
                                                ...
                                                <tbody>
                                                <?php $sql = "SELECT * from tblsporttype";
                                                $query = $dbh->prepare($sql);
                                                $query->execute();
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="edit-sporttype.php?classid=<?php echo htmlentities($result->id); ?>"><i
