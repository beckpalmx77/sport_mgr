...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO  tblsporttype(SportName) VALUES(:SportName)";
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Create ประเภทกีฬา</h2>
                            </div>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Create ประเภทกีฬา</li>
                                </ul>
                            </div>
                                                ...
                                                <div class="form-group has-success">
                                                    ...
                                                    <div class="">
                                                        <input type="text" name="SportName" class="form-control"
                                                               required="required" id="SportName">
                                                    ...
                                                    <!--/div>
                                                       <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="number" name="SportNamenumeric" required="required" class="form-control" id="success">
