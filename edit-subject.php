...
if (strlen($_SESSION['alogin']) == "") {
    ...
    <head>
        ...
        <title>SARRS Admin Update สาขาวิชา/แผนก</title>
                ...
                <div class="main-page">
                    ...
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Update สาขาวิชา/แผนก</h2>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li> ทะเบียนหลัก</li>
                                    <li class="active">Update สาขาวิชา/แผนก</li>
                                </ul>
                            </div>
                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $result) { ?>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">สาขาวิชา/แผนก
                                                            </label>
