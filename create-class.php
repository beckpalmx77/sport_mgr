                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Create ชื่อคณะ/หน่วยงาน</h2>
                            </div>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Create ชื่อคณะ/หน่วยงาน</li>
                                </ul>
                            </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form method="post">
                                                <div class="form-group has-success">
                                                    <label for="success" class="control-label">ชื่อคณะ/หน่วยงาน</label>
