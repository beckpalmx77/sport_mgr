                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h3 align="center">Athlete Record Details</h3>
                                                    <hr />
<?php
// code Student Data
$rollid=$_POST['rollid'];
...
$qery = "SELECT   tblstudents.FirstName,tblstudents.RollId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.RollId=:rollid and tblstudents.ClassId=:classid ";
...
{   ?>
<p><b>Student Name :</b> <?php echo htmlentities($row->FirstName);?></p>
...
// Code for result
 ...
 $query ="select t.FirstName,t.RollId,t.ClassId,t.marks,SubjectId,tblsubjects.SubjectName from (select sts.FirstName,sts.RollId,sts.ClassId,tr.marks,SubjectId from tblstudents as sts join  tblresult as tr on tr.StudentId=sts.StudentId) as t join tblsubjects on tblsubjects.id=t.SubjectId where (t.RollId=:rollid and t.ClassId=:classid)";
