...
<link rel="stylesheet" href="../css/font_mystyle.css?v=1">
...
<nav class="navbar navbar-default bg-success navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#" onmouseover="javascript:msg_wait();">
                <p style="color: yellow">[<?php echo "SARRS | " . $_SESSION['user_name'] ?>]</p></a>
