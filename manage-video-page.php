...
if (isset($_GET['id'])) {
    try {
        ...
        $sqlD = "Select * from tblvideo where id=:id";
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">จัดการ Video</h2>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li> Athlete</li>
                                    <li class="active">จัดการ Video</li>
                                </ul>
                            </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                <a href="add-vdo.php"
                                                   class="btn btn-primary btn-labeled">เพิ่ม Video<span
                                        ...
                                        <div class="panel-body p-20">
                                            <table id="example" class="display table table-striped table-bordered"
                                                ...
                                                <?php $sql = "SELECT tblvideo.* from tblvideo order by id desc ";
                                                $query = $dbh->prepare($sql);
                                                $query->execute();
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlentities($result->video_id); ?></td>
                                                            ...
                                                            <td><?php echo htmlentities($result->type_image=='V' ? "Video":"-"); ?></td>
                                                            <!--td><?php echo htmlentities($result->file_name); ?></td-->
                                                            <!--td><?php echo htmlentities($result->filedoc_desc); ?></td-->
                                                            <td>
                                                                <!--a href="edit-video.php?id=<?php echo htmlentities($result->id); ?>"><i
                                                                        class="fa fa-edit"
    ...
    <script type="text/javascript">
        function delete_id(id) {
            ...
            alertify.confirm('Confirm Delete !!!', 'ต้องการลบรายการนี้ออกจากระบบ?',
                function () {
                    window.location.href = 'manage-video-page.php?id=' + id;
                }
                , function () {
