...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $gender = $_POST['gender'];
        $classid = $_POST['class']===""? '0' : $_POST['class'];
        $subject = $_POST['subject']===""? '0' : $_POST['subject'];
        $dob = $_POST['dob'];
        $hight = $_POST['hight']===""? '0' : $_POST['hight'];
...
*/
        ...
        $sql = "INSERT INTO  tblstudents(RollId,FirstName,LastName,StudentEmail,Gender,ClassId,DOB,hight,weight,BloodGroup,citi_no,Disease
              ,SubjectId,size_shirt,sport_type1,sport_type2,sport_type3,facebook,line,Phone,membertype,EducatId,edutype_id,Class_Education,Level_Education,rh_blood,BMI)
                VALUES ('" . $rollid . "','" . $FirstName . "','" . $LastName
            . "','" . $studentemail
            . "','" . $gender
            . "'," . $classid
            . ",'" . $dob
        ...
        if ($lastInsertId) {
            ...
            $error = "มีข้อผิดพลาดในการบันทึกข้อมูล กรุณาตรวจสอบอีกครั้ง Something went wrong. Please try again !!! " . $sql;
