...
if (strlen($_SESSION['alogin']) == "") {
    ...
    <head>
        ...
        <title>SARRS Admin Update ทะเบียนคณะ/หน่วยงาน</title>
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Update ทะเบียนคณะ/หน่วยงาน</h2>
                            </div>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Update ทะเบียนคณะ/หน่วยงาน</li>
                                </ul>
                            </div>
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                <h5>Update ทะเบียนคณะ/หน่วยงาน</h5>
                                            </div>
                                        </div>
                                        <?php if ($msg) { ?>
                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $result) { ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                        <label for="success"
                                                               class="control-label">ชื่อคณะ/หน่วยงาน</label>
