...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO  tblstudents(FirstName,LastName,RollId,StudentEmail,Gender,ClassId,DOB,hight,weight,BloodGroup,citi_no,Disease
        ...
        VALUES(:FirstName,:LastName,:rollid,:studentemail,:gender,:classid,:dob,:hight,:weight,:BloodGroup,:citi_no,:Disease
        ,:subject,:size_shirt,:sport_type1,:sport_type2,:sport_type3,:facebook,:line,:phone,:membertype,:edutcat_id,:edutype_id,:Class_Education,:Level_Education,:rh_blood,:BMI)";
...
/*      $query->bindParam(':status', $status, PDO::PARAM_STR);     */
        ...
        if ($lastInsertId) {
            ...
            if (strlen($_FILES["fileUpload"]["name"]) > 0) {
                ...
                if (move_uploaded_file($_FILES["fileUpload"]["tmp_name"], $target_file)) {
                    ...
                    $query->bindParam(':stid', $lastInsertId, PDO::PARAM_STR);
                    $query->execute();
                    $success = "Y";
                } else {
                    $success = "N";
            ...
            $error = "Something went wrong. Please try again | " . $Class_Education  ;
        }
    ...
    <head>
        ...
        <title>ARMS Admin| Athlete Admission< </title>
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="default" class="col-sm-2 control-label">ประเภทสมาชิก</label>

                                                <div class="col-sm-10">
                                                    <input type="radio" name="membertype" value="1" required="required"
                                                           checked="">&nbsp;นักศึกษา
                                            ...
                                            <div class="form-group">
                                                <label for="default" class="col-sm-2 control-label">รหัสประจำตัว</label>
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" name="citi_no" class="form-control" id="citi_no"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="radio" name="gender" value="Other" required="required">&nbsp;อื่นๆ
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <select name="sport_type1" class="form-control" id="sport_type1">
                                                ...
                                                <label for="default" class="col-sm-2 control-label">ประเภทกีฬา (สำรอง
                                                    1)</label>

                                                <div class="col-sm-2">
                                                    <select name="sport_type2" class="form-control" id="sport_type2">
                                                        <!--option value="">Select Class</option-->
                                                        <option
                                                ...
                                                <div class="col-sm-2">
                                                    <select name="sport_type3" class="form-control" id="sport_type3">
                                                        <!--option value="">Select Class</option-->
                                                        <option
                                            ...
                                            <div class="form-group">
                                                <label for="default" class="col-sm-2 control-label">โรคประจำตัว</label>
