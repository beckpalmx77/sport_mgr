...
if (isset($_GET['id'])) {
    try {
        ...
        $sqlD = "Select * from tblattach_file where id=:id";
        ...
        $sql = "Delete from tblattach_file where id=:id";
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">จัดการ เอกสาร / ภาพถ่าย </h2>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li> Athlete</li>
                                    <li class="active">จัดการ เอกสาร / ภาพถ่าย</li>
                                </ul>
                            </div>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body p-20">
                                            <table id="example" class="display table table-striped table-bordered"
					                            ...
					                            ,(select tbldoctype.document_type_name from tbldoctype where tbldoctype.id = tblattach_file.filedoc_type) as Doc_Type_Name
					                            ,(select tblstudents.DOB from tblstudents where tblstudents.RollId = tblattach_file.sid) as DOB
                                                from tblattach_file where sid =:std ";
                                                $query = $dbh->prepare($sql);
                                                    ...
                                                    foreach ($results as $result) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <!--img id="picture"
                                                                     src="<?php echo htmlentities($result->file_name) ?>"
                                                                     width="100" height="100"
                                                                     alt="<?php echo htmlentities($result->file_name) ?>"
                                                                     onmouseover="bigImg(this)"
                                                                     onmouseout="normalImg(this)"
                                                                     onclick="window.open(this.src,'_blank')"-->
                                                            ...
                                                            <td><?php echo htmlentities($result->Doc_Type_Name); ?></td>
                                                            <td>
                                                                <a href="edit-files.php?id=<?php echo htmlentities($result->id); ?>"><i
                                                                        class="fa fa-edit"
                                                                ...
                                                                <!--a href="javascript: delete_id(<?php echo htmlentities($result->id) . "," . htmlentities($result->sid); ?>)"><i
                                                                        class="fa fa-times"
                                                                        title="Delete Record"></i></a-->
                                                            </td>
                                                        </tr>
