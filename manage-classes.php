...
if (isset($_GET['id'])) {
    try {
        ...
        $msg = "ลบข้อมูล เรียบร้อยแล้ว Delete Data Successfully";
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">ทะเบียนคณะ/หน่วยงาน</h2>
                            </div>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li> ทะเบียนหลัก</li>
                                    <li class="active">ทะเบียนคณะ/หน่วยงาน</li>
                                </ul>
                            </div>
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                <h5>ทะเบียนคณะ/หน่วยงาน</h5>
                                            </div>
                                        </div>
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                <a href="create-class.php"
                                                   class="btn btn-primary btn-labeled">เพิ่มคณะ/หน่วยงาน<span
    ...
    <script type="text/javascript">
        function delete_id(id) {
            ...
            alertify.confirm('Confirm Delete !!!', 'ต้องการลบรายการนี้ออกจากระบบ?',
                function () {
                    window.location.href = 'manage-classes.php?id=' + id;
                }
                , function () {
