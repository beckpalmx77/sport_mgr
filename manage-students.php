                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">จัดการข้อมูลนักกีฬา/นักศึกษา/บุคลากร </h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Athlete</li>
                                        <li class="active">จัดการข้อมูลนักกีฬา/นักศึกษา/บุคลากร </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <a href="add-students.php"
                                                       class="btn btn-primary btn-labeled">เพิ่มข้อมูล<span
                                            ...
                                            <?php if ($msg) { ?>
                                                ...
                                                <+ขขdiv class="alert alert-success left-icon-alert" role="alert">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                ,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,tblclasses.Section,tblstudents.DOB,tblstudents.status
                                                        ...
                                                        foreach ($results as $result) { ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    &nbsp;
                                                                    <a href="javascript: delete_id(<?php echo htmlentities($result->StudentId); ?>)"><i
                                                                            class="fa fa-times"
        ...
        <script type="text/javascript">
            ...
            function delete_id(id) {
                if (id == null) {
                    ...
                    alertify.confirm('Confirm Delete !!!', 'ต้องการลบรายการนี้ออกจากระบบ?', function(){ window.location.href = 'manage-students.php?id=' + id; }
