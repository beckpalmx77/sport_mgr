...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['update'])) {
        ...
        $value = $mid . "|" . $main_menu_id . "|" . $sub_menu_id . "|" . $label;

        $sql = "update  menu_main set main_menu_id=:main_menu_id,label=:label,link=:link
    ...
    <head>
        ...
        <title>ARMS Admin ปรับปรุง Class</title>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form method="post">
                                                ...
                                                <?php
                                                $mid = intval($_GET['mid']);
                                                $sql = "SELECT menu_main.* from menu_main where menu_main.id=:mid";
                                                ...
                                                <div class="form-group has-success">
                                                    <div class="">
                                                        <input type="text" name="main_menu_id" class="form-control"
                                                               value="<?php echo htmlentities($result->main_menu_id); ?>"
                                                               readonly="true"
                                                ...
                                                <div class="form-group has-success">
                                                    <label for="success" class="control-label">ชื่อเมนูหลัก</label>
