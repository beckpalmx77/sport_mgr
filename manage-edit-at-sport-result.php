...
if (isset($_GET['id'])) {
    try {
        $id = $_GET['id'];
        $sql = "Delete from tblsport_result where id=:id";
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body p-20">
                                            <table id="example" class="display table table-striped table-bordered"
                                                ...
                                                from tblsport_result where stid =:sid ";
                                                $query = $dbh->prepare($sql);
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="edit-at-sport-result.php?id=<?php echo htmlentities($result->id); ?>"><i
                                                                        class="fa fa-edit"
                                                                        title="ดู/แก้ไข"></i></a>
                                                                &nbsp;
...
*/
        ...
        function delete_id(id) {
            if (id == null) {
                ...
                if (confirm('ต้องการลบรายการนี้ออกจากระบบ? ' + id)) {
                    window.location.href = 'manage-edit-at-sport-result.php?id=' + id ;
                }
            }
        }
