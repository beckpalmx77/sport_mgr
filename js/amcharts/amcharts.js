...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, p, q) {
            ...
            this.set = x;
            var u = a.axisThickness, A = a.axisColor, y = a.axisAlpha, B = a.tickLength, D = a.gridAlpha, C = a.gridThickness, K = a.gridColor, H = a.dashLength, Q = a.fillColor, M = a.fillAlpha, P = a.labelsEnabled;
            p = a.labelRotationR;
...
(function () {
    ...
    d.AmGraph = d.Class({
        construct: function (a) {
            ...
            var ma = this.categoryAxis, na = this.baseCoord, Pa = this.negativeBase, Z = this.columnIndex, da = this.lineThickness, X = this.lineAlpha,
                xa = this.lineColorR, ea = this.dashLength, fa = this.set, Ba, ga = this.getGradRotation(), V = this.chart.columnSpacing, Y = ma.cellWidth, Da = (Y * k - r) / r;
            V > Da && (V = Da);
            ...
            for (L = P; L <= ia; L++) {
                ...
                var S, R, J, ba, ja = NaN, E = NaN, F = NaN, O = NaN, N = NaN, qa = NaN, ra = NaN, sa = NaN, ta = NaN, ya = NaN, Ea = NaN, ka = NaN, la = NaN, W = NaN, zb = NaN, Ab = NaN, ua = NaN, va = void 0, Na = wb, Va = Ya, Ha = xa, Ca, za, Bb = this.proCandlesticks, mb = this.topRadius, Fa = q - 1, pa = p - 1, bb = this.pattern;
                        ...
                        case "candlestick":
                            if (!isNaN(ua) && !isNaN(W)) {
                                ...
                                if (t) {
                                    ...
                                    if (S < p && 0 < J) {
                                        Bb && W >= ua && (Va = 0);
                                        var va = new d.Cuboid(h, J, ba, H, Q, Na, Va, da, Ca, X, ga, w, t, ea, bb, mb, aa), Gb, Hb;
...
(function () {
    ...
    d.ChartCursor = d.Class({
        ...
        updateFullLine: function () {
            ...
            if (this.mouseIsDown) {
                var a =
                    d.roundTo((this.mouseX - this.mouseX0) / this.width, 3), b = d.roundTo((this.mouseY - this.mouseY0) / this.height, 3), c = d.roundTo((this.mouse2X - this.mouse2X0) / this.width, 3), e = d.roundTo((this.mouse2Y - this.mouse2Y0) / this.height, 2), h = !1;
        ...
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var r = this.horizontalPadding, w = this.verticalPadding, z = this.pointerWidth, x = this.pointerOrientation, u = this.cornerRadius,
                    ...
                    D < g && (D = g);
                    D + C > l && (D = l - C);
                    var k = y + w, m = D + r, M = this.shadowAlpha, P = this.shadowColor, r = this.borderThickness, ia = this.bulletSize, I, w = this.fillAlpha, aa = this.borderAlpha;
...
(function () {
    ...
    d.TrendLine = d.Class({
        construct: function (a) {
            ...
            var a = this;
            a.destroy();
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, p = a.finalDate, q = a.finalCategory, n = a.valueAxis, t = a.valueAxisX, r = a.initialXValue, w = a.finalXValue,
...
(function () {
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, p, q, n, t) {
        ...
        359.94 < x && (x = 359.94);
        h >= x && (h = x);
        var u = 1 / 180 * Math.PI, x = b + Math.sin(e * u) * k, A = c - Math.cos(e * u) * w, y = b + Math.sin(e * u) * f, B = c - Math.cos(e * u) * g, D = b + Math.sin((e + h) * u) * f, C = c - Math.cos((e + h) * u) * g, K = b + Math.sin((e + h) * u) * k, u = c - Math.cos((e + h) * u) * w, H = {
